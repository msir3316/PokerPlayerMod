...
public class PlaceholderRelic2 extends CustomRelic {
    ...
    // ID, images, text.
    public static final String ID = TrumpTheSpire.makeID("PlaceholderRelic2");
    public static final String IMG = TrumpTheSpire.makePath(TrumpTheSpire.PLACEHOLDER_RELIC_2);
    public static final String OUTLINE = TrumpTheSpire.makePath(TrumpTheSpire.PLACEHOLDER_RELIC_OUTLINE_2);
