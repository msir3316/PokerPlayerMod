...
import trumpthespire.potions.*;
import trumpthespire.patches.*;
import trumpthespire.relics.*;
import trumpthespire.variables.*;
import trumpthespire.cards.*;
import trumpthespire.characters.*;
...
public class TrumpTheSpire
    ...
    public TrumpTheSpire() {
        ...
        logger.info("Creating the color " + AbstractCardEnum.TRUMP_GRAY.toString());

        BaseMod.addColor(AbstractCardEnum.TRUMP_GRAY, DEFAULT_GRAY, DEFAULT_GRAY, DEFAULT_GRAY,
    ...
    public void receiveEditCharacters() {
        logger.info("begin editing characters. " + "Add " + TheDefaultEnum.THE_TRUMP.toString());

        BaseMod.addCharacter(new TheDefault("the Default", TheDefaultEnum.THE_TRUMP),
                makePath(THE_DEFAULT_BUTTON), makePath(THE_DEFAULT_PORTRAIT), TheDefaultEnum.THE_TRUMP);
    ...
    public void receiveEditPotions() {
        ...
        // Class Specific Potion If you want your potion to not be class-specific, just remove the player class at the end (in this case the "TheDefaultEnum.THE_TRUMP")
        BaseMod.addPotion(PlaceholderPotion.class, PLACEHOLDER_POTION_lIQUID, PLACEHOLDER_POTION_HYBRID, PLACEHOLDER_POTION_SPOTS, PlaceholderPotion.POTION_ID, TheDefaultEnum.THE_TRUMP);
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelicToCustomPool(new PlaceholderRelic(), AbstractCardEnum.TRUMP_GRAY);
