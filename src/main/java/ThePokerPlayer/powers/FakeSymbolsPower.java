...
public class FakeSymbolsPower extends AbstractPower {
	public AbstractCreature source;

	private static final String RAW_ID = "FakeSymbolsPower";
	...
	public FakeSymbolsPower(AbstractCreature owner, AbstractCreature source, int amount) {
		this.name = NAME;
		this.ID = POWER_ID;
		this.owner = owner;
		this.amount = amount;
