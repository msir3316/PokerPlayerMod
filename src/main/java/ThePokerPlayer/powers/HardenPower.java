...
public class HardenPower extends AbstractPower {
	public AbstractCreature source;

	private static final String RAW_ID = "HardenPower";
	...
	public HardenPower(AbstractCreature owner, AbstractCreature source, int amount) {
		this.name = NAME;
		this.ID = POWER_ID;
		this.owner = owner;
		this.amount = amount;
