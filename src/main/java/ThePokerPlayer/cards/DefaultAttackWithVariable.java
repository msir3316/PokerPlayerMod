...
public class DefaultAttackWithVariable extends CustomCard {
	...
	public static final String ID = PokerPlayerMod.makeID("DefaultAttackWithVariable");
	private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
	public static final String IMG = PokerPlayerMod.makePath(PokerPlayerMod.DEFAULT_COMMON_ATTACK);
