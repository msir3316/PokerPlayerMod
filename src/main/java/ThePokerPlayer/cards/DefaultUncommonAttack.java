...
public class DefaultUncommonAttack extends CustomCard {
    ...
    public static final String ID = PokerPlayerMod.makeID("DefaultUncommonAttack");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = PokerPlayerMod.makePath(PokerPlayerMod.DEFAULT_UNCOMMON_ATTACK);
