...
import ThePokerPlayer.powers.RarePower;
...
public class DefaultRarePower extends CustomCard {
    ...
    public static final String ID = PokerPlayerMod.makeID("DefaultRarePower");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = PokerPlayerMod.makePath(PokerPlayerMod.DEFAULT_RARE_POWER);
