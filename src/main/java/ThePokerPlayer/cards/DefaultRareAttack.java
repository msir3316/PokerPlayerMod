...
public class DefaultRareAttack extends CustomCard {
    ...
    public static final String ID = PokerPlayerMod.makeID("DefaultRareAttack");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = PokerPlayerMod.makePath(PokerPlayerMod.DEFAULT_RARE_ATTACK);
