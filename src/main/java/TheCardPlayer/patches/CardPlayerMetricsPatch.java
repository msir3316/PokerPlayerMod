...
public class CardPlayerMetricsPatch {
	...
	public static class SendPostPatch {
		...
		public static void Prefix(Metrics __instance, @ByRef String[] url, String fileName) {
			...
			if (AbstractDungeon.player.chosenClass == TheCardPlayerEnum.THE_CARD_PLAYER) {
	...
	public static class RunPatch {
		...
		public static void Postfix(Metrics __instance) {
			if (__instance.type == Metrics.MetricRequestType.UPLOAD_METRICS && AbstractDungeon.player.chosenClass == TheCardPlayerEnum.THE_CARD_PLAYER) {
				try {
