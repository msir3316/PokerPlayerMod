...
public class DefaultUncommonAttack extends CustomCard {
    ...
    public static final String ID = CardPlayerMod.makeID("DefaultUncommonAttack");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = CardPlayerMod.makePath(CardPlayerMod.DEFAULT_UNCOMMON_ATTACK);
