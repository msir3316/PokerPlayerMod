...
public class DefaultAttackWithVariable extends CustomCard {
    ...
    public static final String ID = CardPlayerMod.makeID("DefaultAttackWithVariable");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = CardPlayerMod.makePath(CardPlayerMod.DEFAULT_COMMON_ATTACK);
