...
public class DefaultRareAttack extends CustomCard {
    ...
    public static final String ID = CardPlayerMod.makeID("DefaultRareAttack");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = CardPlayerMod.makePath(CardPlayerMod.DEFAULT_RARE_ATTACK);
