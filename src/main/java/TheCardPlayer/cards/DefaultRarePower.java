...
import TheCardPlayer.powers.RarePower;
...
public class DefaultRarePower extends CustomCard {
    ...
    public static final String ID = CardPlayerMod.makeID("DefaultRarePower");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = CardPlayerMod.makePath(CardPlayerMod.DEFAULT_RARE_POWER);
