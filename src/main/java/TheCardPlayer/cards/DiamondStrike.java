...
public class DiamondStrike extends CustomCard {
	...
	public static final String IMG = CardPlayerMod.GetCardPath(RAW_ID);
	private static final int COST = 1;
	public static final String DESCRIPTION = cardStrings.DESCRIPTION;
	private static final AbstractCard.CardType TYPE = CardType.ATTACK;
	private static final AbstractCard.CardColor COLOR = CardColorEnum.CARD_PLAYER_GRAY;
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		...
		AbstractCard c = new PlayingCard(PlayingCard.Suit.Diamond, AbstractDungeon.cardRandomRng.random(1, 10));
