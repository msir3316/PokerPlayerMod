...
public class PlaceholderRelic2 extends CustomRelic {
    ...
    // ID, images, text.
    public static final String ID = CardPlayerMod.makeID("PlaceholderRelic2");
    public static final String IMG = CardPlayerMod.makePath(CardPlayerMod.PLACEHOLDER_RELIC_2);
    public static final String OUTLINE = CardPlayerMod.makePath(CardPlayerMod.PLACEHOLDER_RELIC_OUTLINE_2);
