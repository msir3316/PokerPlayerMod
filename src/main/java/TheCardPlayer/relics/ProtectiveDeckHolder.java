...
public class ProtectiveDeckHolder extends CustomRelic {
	...
	public static final String ID = CardPlayerMod.makeID("ProtectiveDeckHolder");
	public static final String IMG = CardPlayerMod.makePath(CardPlayerMod.PLACEHOLDER_RELIC);
	public static final String OUTLINE = CardPlayerMod.makePath(CardPlayerMod.PLACEHOLDER_RELIC_OUTLINE);
