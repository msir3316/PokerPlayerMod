...
public class PlayingCardDiscoveryAction extends AbstractGameAction {
	...
	public static PlayingCard.Suit suit;
	...
	public PlayingCardDiscoveryAction(PlayingCard.Suit suit) {
		this(suit, 1, 10);
	}
	...
	public PlayingCardDiscoveryAction(PlayingCard.Suit suit, int min, int max) {
